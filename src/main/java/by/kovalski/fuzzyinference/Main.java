...
//        List<FuzzyPredicate> sets = knowledgeBaseParser.parseFuzzyPredicate();
//        List<BinaryFuzzyPredicate> binaryFuzzyPredicates = knowledgeBaseParser.parseBinaryFuzzyPredicate(sets);
